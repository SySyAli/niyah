...
export const Onboarding2Scene: React.FC<Onboarding2SceneProps> = ({
  ...
  return (
    ...
    >
      ...
      <Animated.View
        style={[styles.abs, { left: fx(182), top: fy(236) }, phoneTrenchAnim]}
      >
      ...
      >
        ...
        {/* Small peach blob */}
        <View style={[styles.abs, { left: fx(42.52), top: fy(556.96) }]}>
        ...
        <View
          style={[
            styles.abs,
            { left: fx(83), top: fy(543), transform: [{ rotate: "165deg" }] },
          ]}
        >
        ...
        <View
          style={[
            styles.abs,
            { left: fx(87), top: fy(543), transform: [{ rotate: "-15deg" }] },
          ]}
        >
        ...
        <View
          style={[
            styles.abs,
            { left: fx(109), top: fy(537), transform: [{ rotate: "-15deg" }] },
          ]}
        >
          <Text style={[styles.dollarText, { fontSize: fd(8) }]}>$1</Text>
        </View>
        <View
          style={[
            styles.abs,
            { left: fx(82), top: fy(567), transform: [{ rotate: "15deg" }] },
          ]}
        >
          <Text style={[styles.dollarText, { fontSize: fd(8) }]}>$1</Text>
        </View>
        <View
          style={[
            styles.abs,
            { left: fx(104), top: fy(573), transform: [{ rotate: "15deg" }] },
          ]}
        >
          <Text style={[styles.dollarText, { fontSize: fd(8) }]}>$1</Text>
        </View>
        ...
        >
          <PhoneFight w={fd(184.6)} h={fd(190)} />
        </View>
